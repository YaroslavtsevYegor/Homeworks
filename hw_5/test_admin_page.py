...
def test_username_field(browser):
    browser.get(browser.current_url + "/administration")
    WebDriverWait(browser, 5).until(EC.visibility_of_element_located((By.ID, "input-username")))


def test_password_field(browser):
    browser.get(browser.current_url + "/administration")
    WebDriverWait(browser, 5).until(EC.visibility_of_element_located((By.ID, "input-password")))
